...
export const Reserve = () => {
	...
	return (
		<motion.section
			...
			id='home'
			className='overflow-hidden h-full pt-20 lg:pb-20 flex w-full relative bg-white justify-center items-center min-h-screen'
		>
			<div className='flex flex-col justify-center items-center z-10 container mx-auto'>
				<motion.div
					...
					className=' transition duration-500 flex flex-col items-center justify-center bg-base-dark bg-opacity-80 lg:bg-reserve rounded-md p-5 lg:p-10'
				>
					...
					<div className='flex flex-row '>
						<div className='mx-auto w-full lg:max-w-[400px] '>
							<form method='POST' className='flex flex-col lg:gap-y-5 gap-y-0'>
								<div className='flex h-15 bg-white items-center rounded mb-6 pr-10'>
									...
									<div className='text-[20px] flex-1 font-medium text-black outline-none focus:border-none'>
										<DatePicker
											selected={date}
						...
						<div className='hidden lg:flex flex-col justify-center items-center gap-y-2'>
							<h2 className='text-white font-roboto-bold text-4xl'>We will wait for you</h2>
